...
/** Validate an `{x, y, z}` object of finite numbers. Used by sculpt tools
 *  where the AI passes coordinates as objects rather than tuples. */
export function assertXYZ(val: unknown, paramName: string): { x: number; y: number; z: number } {
