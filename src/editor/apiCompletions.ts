...
const API_MEMBERS: Completion[] = [
  ...
  val('fasteners', 'namespace', 'Hardware fits: screw/tap holes, insert bosses, nut pockets, clearance presets, calibration coupon. See /ai/print-fit.md.', 'variable'),
  val('joints', 'namespace', 'Part-to-part joinery: pins, dovetails, snap-fits, print-in-place hinges, ball joints, snap rims. See /ai/print-fit.md.', 'variable'),
