  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        name: {
          type: 'string',
          enum: ['curves', 'bosl2', 'replicad', 'sdf', 'voxel', 'colors', 'print-safety', 'print-fit', 'reference-images', 'file-io', 'annotations', 'relief'],
...
const SUBDOC_NAMES = new Set(['curves', 'bosl2', 'replicad', 'sdf', 'voxel', 'colors', 'print-safety', 'print-fit', 'reference-images', 'file-io', 'annotations', 'relief', 'iteration-workflow', 'gotchas', 'visual-verification', 'spending', 'manifold-api']);
