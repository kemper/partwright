...
export const HELP_STATIC_SECTIONS: ContentSection[] = [
  ...
  },
  {
    ...
    body:
      ...
      '<li><strong class="text-zinc-300">Light</strong> — Toggle studio lighting and a soft ground shadow. Off by default for a fast, flat view; turn it on for a richer lit look when you want to show a model off.</li>' +
