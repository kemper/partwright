...
export const LEGAL_SECTIONS: ContentSection[] = [
  {
    ...
    heading: 'Privacy',
    body:
      'Partwright has <strong class="text-zinc-300">no backend of its own</strong> and <strong class="text-zinc-300">no account</strong>. Nothing you create — your models, code, painted colors, notes, or attached images — is ever uploaded to us.<br><br>' +
      ...
      '<strong class="text-zinc-300">Anonymous usage analytics.</strong> So we can see roughly how many people use Partwright and which pages they open, the site uses <a href="https://www.cloudflare.com/web-analytics/" target="_blank" rel="noopener" class="text-blue-400 hover:underline">Cloudflare Web Analytics</a>. It is <strong class="text-zinc-300">privacy-first and cookieless</strong>: it sets no cookies, does not fingerprint your device, and does not track you across other sites. It records only <strong class="text-zinc-300">aggregate</strong> figures — page views, the referring site, country, and browser type — and can\'t identify you or see anything you make. If you\'d rather not be counted at all, any content/privacy blocker will stop the beacon, and there is no per-user profile to delete.<br><br>' +
