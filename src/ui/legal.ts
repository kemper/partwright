  ...
  const sections: LegalSection[] = [
    {
      ...
      body:
        ...
        'All of your work — sessions, saved versions, notes, annotations, painted color regions, and attached images — is stored <strong class="text-zinc-300">locally in your own browser</strong> via <code class="text-emerald-400 bg-zinc-800 px-1 rounded">localStorage</code> and <code class="text-emerald-400 bg-zinc-800 px-1 rounded">IndexedDB</code>. Clearing your browser data, or using the "Uninstall / start fresh" control on the home page, removes it permanently.<br><br>' +
